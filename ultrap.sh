...
appops set com.dts.freefireth AUDIO_MEDIA_ VOLUME deny
...
IP_LIST=(
  ...
  "23.200.143.6" "23.2.16.9" "13.225.175.125" "99.84.138.11"
)
spinner="/-\|"
i=0
...
for ip in "${IP_LIST[@]}";do
  ...
  iptables -t mangle -A POSTROUTING -d 103.108.103.0/24 -j MARK --set-mark 10 > /dev/null 2>&1
...
for IFACE in "${IFACES[@]}"; do
  ...
  iptables -t mangle -D POSTROUTING -d 103.108.103.0/24 -j MARK --set-mark 10 > /dev/null 2>&1
